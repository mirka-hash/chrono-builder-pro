...
export default function Dashboard() {
  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        <h1 className="text-4xl font-bold mb-2 tracking-tight">Good Morning, Alex!</h1>
        <p className="text-muted-foreground text-base">Here's what's happening with your projects today.</p>
      </div>
